...
class Payload
{
   ...
   */
    ...
    {   
        ...
        //url do qrcode         // não precida da chave pix da conta
        $url = $this->getValue(self::ID_MERCHANT_ACCOUNT_INFORMATION_URL, preg_replace('/^https?^\:\/\//','', $this->url ) );
